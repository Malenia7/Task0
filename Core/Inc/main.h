...
/* Private defines -----------------------------------------------------------*/
#define EXT_5KEY_Pin GPIO_PIN_0
#define EXT_5KEY_GPIO_Port GPIOA
#define EXT_5KEY_EXTI_IRQn EXTI0_IRQn
...
#define TIM2_LCD_BL_Pin GPIO_PIN_10
#define TIM2_LCD_BL_GPIO_Port GPIOB
